label kitty1:
    ...
    "And the winner of the worst analogy award goes to..."
    ...
    "I described one of the best fights in SFC history in the most boring way possible."
    ...
    "She's got quite the accent on her."
    ...
    z "I think I cut myself with that one."
