...
init:
    ...
    image kat me normal u color = "kat/KatNormalMeUColor.png"
    image kat away normal u color = "kat/KatNormalAwayUColor.png"
    image kat me normal u black = "kat/KatNormalMeU.png"
    image kat away normal u black = "kat/KatNormalAwayU.png"

    image kat me mad u color = "kat/KatAngryMeUColor.png"
    image kat away mad u color = "kat/KatAngryAwayUColor.png"
    image kat me mad u black = "kat/KatAngryMeU.png"
    image kat away mad u black = "kat/KatAngryAwayU.png"
    image kat me angry u color = "kat/KatTeethMeUColor.png"
    image kat away angry u color = "kat/KatTeethAwayUColor.png"
    image kat me angry u black = "kat/KatTeethMeU.png"
    image kat away angry u black = "kat/KatTeethAwayU.png"

    image kat me smile u color = "kat/KatSmileMeUColor.png"
    image kat away smile u color = "kat/KatSmileAwayUColor.png"
    image kat me smile u black = "kat/KatSmileMeU.png"
    image kat away smile u black = "kat/KatSmileAwayU.png"

    image kat me normal u color flip = im.Flip("kat/KatNormalMeUColor.png", horizontal=True)
    image kat away normal u black flip = im.Flip("kat/KatNormalAwayUColor.png", horizontal=True)

    image kat me smile u color flip = im.Flip("kat/KatSmileMeUColor.png", horizontal=True)
    image kat away smile u color flip = im.Flip("kat/KatSmileAwayUColor.png", horizontal=True)

    # ~~~~~~~~~~~images of Kat in normal clothes~~~~~~~~~~~~~~~~~
    image kat me normal n color = "kat/KatNNormal2.png"
    image kat away normal n color = "kat/KatNNormal.png"
    image kat me normal n black = "kat/KatNNormal3.png"
    image kat away normal n black = "kat/KatNNormal4.png"

    image kat me mad n color = "kat/KatNAngry.png"
    image kat away mad n color = "kat/KatNAngry2.png"
    image kat me mad n black = "kat/KatNAngry3.png"
    image kat away mad n black = "kat/KatNAngry4.png"
    image kat me angry n color = "kat/KatNAngry5.png"
    image kat away angry n color = "kat/KatNAngry6.png"
    image kat me angry n black = "kat/KatNAngry7.png"
    image kat away angry n black = "kat/KatNAngry8.png"

    image kat me smile n color = "kat/KatNSmile.png"
    image kat away smile n color = "kat/KatNSmile2.png"
    image kat me smile n black = "kat/KatNSmile3.png"
    image kat away smile n black = "kat/KatNSmile4.png"
    
    # ~~~~~~~~~~~~images of Kat in Dress~~~~~~~~~~~~~~~~~~~~~~~~~~~
    image kat angry me black d = "kat/KatDAngry3.png"
    
    image kat normal d black me = "kat/KatDNormal.png"
    ...
    #~~~ images of Chris
    image chris smile = "ChrisNSmile.png"
    image chris normal = "ChrisNNormal.png"
    
    #~~~ images of Holly
    image holly me smile n = "HollySmileMeN.png"
    image holly away smile n = "HollySmileAwayN.png"
    image holly me teeth n = "HollyTeethMeN.png"
    image holly away teeth n = "HollyTeethAwayN.png"
...
label start:
    ...
    show kat away normal u black flip
    with dissolve
    ...
    k "And you like getting your hotdog and eggs sucked."
    ...
    k "This is a pretty good place."
    
    show kat me smile u black
    with dissolve
    
    k "I wish I could stay here with you."
    ...
    k "I think I'm going to like you."
    ...
    k "First of all, this breakfast is great."
    
    show kat me smile u black:
    
    z "Thank you."
    
    k "You're very analytical, something I'm pretty bad at."
    
    "I am studying Computer Science."
    
    "Analyzing code was my specialty."
    
    k "And judging by your choice of condoms, you're probably a thoughtful and sensitive person."
    ...
    k "Well yeah. Okay. There's that too."
    
    z "Can you recall anything from last night?"
    
    k "If I did I would tell you anything I know."
    ...
    k "I'm enjoying spending time with you right now."
    
    k "I kinda feel like that's gonna end if we call them."
    ...
    k "I don't know Gale that much."
    
    k "I just kinda live across the hall from her."
    
    k "She probably chose me cuz I wouldn't judge her for getting back with Chris."
    ...
    k "You like girls who color their hair?"
    ...
    k "I really think I'm going to like you Zen."
    
    z "Thank you. I guess."
    
    k "It's been one crazy night."
    
    k "For some reason, I'm wearing your shorts. And I don't think you're a pervert despite it."
    ...
    k "Try not to analyze or figure out what happened last night."
    
    k "I'm pretty sure we did something stupid and we didn't even sleep together."
    
    "Well, technically we did."
    
    k "If we learn the details of last night, it's going to be weird."
    
    show kat smile
    with dissolve
    
    k "The fact that I'm here with you alone means that Drunk Kat found something special in you."
    
    k "The important part is we had fun and I made a new friend."
    
    "Weirdo"
    
    z "T-thanks. I guess."
    
    k "You probably want to live alone, or with Chris."
    
    k "So I won't try insist to live here."
    
    k "But if you're looking for a roomate, I would love that."
    ...
    show expression Text(_("Try not to analyze or figure out what happened last night."), size=25, yalign=0.5, xalign=0.5, drop_shadow=(2, 2)) as text
    with dissolve
    $ renpy.pause (2, hard=True)
    hide text
    with dissolve
    ...
    k "Aauugghh!{w} Who the fuck is this?!{w} Some people are trying to FUCKING SLEEP!"
    ...
    k "Sorry about that, I get really cranky when I try to sleep."
    
    k "Don't feel bad about it."
    
    z "O-kay."
    
    k "You know, normally, guys wait 3 days before they call a girl they just met, not 3 minutes."
    
    "She's kinda talkative on the phone."
    
    "She starts yawning."
    
    k "You have yet to say anything you know."
    
    k "Did you just call to give me your number?"
    
    z "Uh... sorry... yeah..."
    
    k "Alright then."
    
    k "Look, I really want to go back to sleep."
    
    k "I'm guessing you're still frozen from when I yelled at you."
    
    k "So I'll hang up now."
    ...
    c "You and Kat were with us in Lakside."
    ...
    c "You even drunkely said something about bed rules."
