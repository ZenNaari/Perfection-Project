...
init -1 python hide:
    ...
    config.window_title = u"Perfection Project"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Perfection Project"
    config.version = "0.0"
    ...
    #style.default.font = "ComicNeue_Bold.otf"
    ...
    config.main_menu_music = "CoolVibes.mp3"
...
python early:
    config.save_directory = "Perfection Project-1420907434"
...
init python:
    ...
    build.directory_name = "PerfectionProject-0.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "PerfectionProject"
